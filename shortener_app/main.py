...
def get_admin_info(db_url: models.URL) -> schemas.URLInfo:
    ...
    admin_endpoint = app.url_path_for(
        "adminstration info", secret_key= db_url.secret_key
    )
...
@app.get("/admin/{secret_key}", name="adminstration info", response_model=schemas.URLInfo)
